...
ActiveRecord::Schema.define(version: 20150105235753) do
  ...
  create_table "spree_issues", force: true do |t|
    ...
    t.integer  "shipped_issues_count", default: 0
  end

  add_index "spree_issues", ["magazine_id"], name: "index_spree_issues_on_magazine_id", using: :btree
  add_index "spree_issues", ["magazine_issue_id"], name: "index_spree_issues_on_magazine_issue_id", using: :btree
  ...
  add_index "spree_shipped_issues", ["issue_id"], name: "index_spree_shipped_issues_on_issue_id", using: :btree
  add_index "spree_shipped_issues", ["subscription_id"], name: "index_spree_shipped_issues_on_subscription_id", using: :btree
